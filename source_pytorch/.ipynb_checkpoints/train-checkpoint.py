...
from model import Vol_Predictor
...
def model_fn(model_dir):
    ...
    model = Vol_Predictor(model_info['input_dim'], model_info['hidden_dim'], model_info['output_dim'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=3, metavar='N',
                        help='number of input_dim (default: 3)')
    ...
    model = Vol_Predictor(args.input_dim, args.hidden_dim, args.output_dim).to(device)
